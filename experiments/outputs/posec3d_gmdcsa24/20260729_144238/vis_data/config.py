...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='datasets/annotations/gmdcsa24_pose_test.pkl',
        pipeline=[
            dict(
                clip_len=48,
                num_clips=10,
...
train_dataloader = dict(
    batch_size=8,
    dataset=dict(
        ann_file='datasets/annotations/gmdcsa24_pose_train.pkl',
        pipeline=[
...
val_dataloader = dict(
    batch_size=8,
    dataset=dict(
        ann_file='datasets/annotations/gmdcsa24_pose_val.pkl',
        pipeline=[
            dict(
                clip_len=48,
                num_clips=1,
...
work_dir = 'C:\\Users\\John\\Desktop\\look model\\experiments\\outputs\\posec3d_gmdcsa24'
