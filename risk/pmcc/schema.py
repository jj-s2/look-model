...
class DailyObservation:
    ...
    def __post_init__(self) -> None:
        ...
        object.__setattr__(self, "provenance", MappingProxyType(_mapping(self.provenance, "provenance")))
    ...
    def from_dict(cls, data: Mapping[str, Any]) -> "DailyObservation":
        ...
        return cls(
            ...
            observed_at=datetime.fromisoformat(copied.get("observed_at", "")),
            features=copied.get("features", {}),
...
class ChangeEvent:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {"subject_id": self.subject_id, "occurred_at": self.occurred_at.isoformat(), "feature": self.feature,
                ...
                "confidence": self.confidence, "provenance": dict(self.provenance)}

    @classmethod
    def from_dict(cls, data: Mapping[str, Any]) -> "ChangeEvent":
        copied = _mapping(data, "data")
        return cls(copied.get("subject_id"), datetime.fromisoformat(copied.get("occurred_at", "")),
...
class TemporalChain:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {"subject_id": self.subject_id, "created_at": self.created_at.isoformat(),
                ...
                "changes": [item.to_dict() for item in self.changes], "provenance": dict(self.provenance)}

    @classmethod
    def from_dict(cls, data: Mapping[str, Any]) -> "TemporalChain":
        copied = _mapping(data, "data")
        return cls(copied.get("subject_id"), datetime.fromisoformat(copied.get("created_at", "")),
...
class PMCCForecast:
    ...
    def from_dict(cls, data: Mapping[str, Any]) -> "PMCCForecast":
        ...
        return cls(copied.get("subject_id"), datetime.fromisoformat(copied.get("forecast_at", "")),
...
class OutcomeFeedback:
    ...
    def from_dict(cls, data: Mapping[str, Any]) -> "OutcomeFeedback":
        copied = _mapping(data, "data")
        return cls(copied.get("subject_id"), datetime.fromisoformat(copied.get("recorded_at", "")),
